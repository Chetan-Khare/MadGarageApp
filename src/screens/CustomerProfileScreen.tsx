...
type Props = { navigation: NativeStackNavigationProp<RootStackParamList, 'CustomerProfile'>; };
        ...
        try {
            ...
            if (response.data) {
                ...
                if (response.data.profileImageUrl) {
                    // FE-04 FIX: Use exported BASE_SERVER_URL constant instead of fragile string replacement
    ...
    return (
        <View style={[styles.safe, { backgroundColor: T.bg, paddingTop: Math.max(insets.top, 50) }]}>
            ...
            <View style={[styles.header, { borderBottomColor: T.headerBorder }]}>
                ...
                <Text style={[styles.headerTitle, { color: T.text }]}>My Profile</Text>
                <View style={{ width: 38 }} />
            </View>
                    ...
                    <View style={styles.avatarContainer}>
                        ...
                        >
                            {uploadingImage ? (
                                ...
                                <Ionicons name="camera" size={40} color={T.subText} />
                            )}
                        </TouchableOpacity>
                        <Text style={[styles.avatarSubtitle, { color: T.subText }]}>Tap image to update photo</Text>
                    </View>

                    <View style={[styles.card, { backgroundColor: T.card, borderColor: T.cardBorder }]}>
                        <View style={styles.cardHeader}>
                            <Ionicons name="id-card-outline" size={20} color={T.text} />
                            <Text style={[styles.cardTitle, { color: T.text }]}>Personal Details</Text>
                        </View>
