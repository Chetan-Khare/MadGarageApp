                ...
                <ScrollView contentContainerStyle={styles.scrollContent}>
                    ...
                    <View style={[styles.card, { backgroundColor: T.card, borderColor: T.cardBorder }]}>
                        <View style={styles.cardHeader}>
                            ...
                            <Text style={[styles.cardTitle, { color: T.text }]}>Business Location</Text>
                        </View>

                        <View style={styles.inputGroup}>
                            <Text style={[styles.label, { color: T.subText }]}>Operating City / Area</Text>
                            <TextInput
                                style={[styles.input, { backgroundColor: T.inputBg, color: T.text, borderColor: T.inputBorder }]}
                        ...
                        <View style={styles.inputGroup}>
                            <Text style={[styles.label, { color: T.subText }]}>Store Address</Text>
                            <TextInput
